...
class Mongo:
    ...
    def query_loan_information_result(self, thread_id):
        '''查询放款结果'''
        collections = self.db.loan_Information
        # 查询结果
        results = collections.find_one({'thread_id': thread_id})
        return results
...
if __name__ == '__main__':
    result = Mongo('fund_uat').query_loan_information_result('LVk5UDlfIyU1NUI0VDhTRjI5JSU=')
    print(result)
